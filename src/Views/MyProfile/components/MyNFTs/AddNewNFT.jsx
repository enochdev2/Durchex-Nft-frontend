...
import {
  ...
  publicMint,
  vendorMint,
} from "../../../../hooks/ContractControllers/useMintNFT";
...
function AddNewNFT() {
  ...
  const [imageURL, setimageURL] = useState(
    "https://copper-leading-yak-964.mypinata.cloud/ipfs/QmWpbpXTRhfDEEzGLJ75GBQSqHwoNknUd493rJZFcfe9LH"
  );
  ...
  const uploadToIPFS = async (file) => {
    if (file) {
      try {
        ...
        console.log(
          "🚀 ~ uploadJSONToIPFS ~ process.env.REACT_APP_PINATA_SECRET_KEY:",
          process.env.REACT_APP_PINATA_SECRECT_KEY
        );
        console.log(
          "🚀 ~ uploadJSONToIPFS ~ process.env.REACT_APP_PINATA_API_KEY,:",
        ...
        const response = await axios({
          ...
          headers: {
            ...
            // pinata_secret_api_key: process.env.REACT_APP_PINATA_SECRECT_KEY,
  ...
  const HandleMintNFT = async (event) => {
    ...
    try {
      ...
      console.log(
        ...
        process.env.REACT_APP_NFTMARKETPLACE_CONTRACT_ADDRESS
      );
